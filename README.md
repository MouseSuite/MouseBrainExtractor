...
We have pre-trained weights available at [https://data.mousesuite.org/mbe/MBE_weights.tar.gz](https://data.mousesuite.org/mbe/MBE_weights.tar.gz) for the following datasets:
...
You can download the singularity image from [here](https://data.mousesuite.org/mbe/mbe.img).
...
All our weights can be downloaded from [here](https://data.mousesuite.org/mbe/MBE_weights.tar.gz) as a tar file (approximately 531 MB). 
